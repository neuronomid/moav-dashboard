 ...
 */
async function getWireGuardUsage() {
    const usage = new Map();
    try {
 ...
 */
async function getSingBoxUsage() {
    const usage = new Map();
    try {
 ...
 */
async function checkDataLimits(serverId, usageMap) {
    try {
...
export async function updateUsageStats(serverId) {
...
let interval = null;
export function startUsageMonitor(serverId) {
    // Update immediately
